<template>
	<v-row class="pb-12 fill-height d-flex flex-column" no-gutters align="center" justify="center">
		<h1 class="py-6" style="color: white">Quarkus UI</h1>
		<div class="text-center">
			<v-row no-gutters justify="center" align="center">
				<v-card style="width: 476px; backdrop-filter: blur(10px)" class="rounded-lg card-login" raised color="rgba(255, 255, 255, 0.75) !important">
						...
						<v-form ref="form" autocomplete="off">
							...
							<v-col cols="12" class="d-flex flex-column pa-0 pt-2" align-self="center">
								<v-row no-gutters class="mb-4" justify="center">
									<v-btn color="primary" class="elevation-0" @click="login()">Login</v-btn>
								</v-row>
							</v-col>
						</v-form>
					</div>
